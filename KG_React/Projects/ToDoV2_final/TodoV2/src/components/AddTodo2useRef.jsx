...
function AddTodo2useRef({ onClickADD }) {
...
// By using useRef() we can change the value of our props, components and also lessen the number of repainting of our whole page:
